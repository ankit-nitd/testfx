...
namespace Microsoft.VisualStudio.TestPlatform.MSTestAdapter.PlatformServices.Utilities
{
    ...
    {
        private IReflectionOperations reflectionUtility;
        ...
        internal DeploymentItemUtility()
        {
            this.reflectionUtility = PlatformServiceProvider.Instance.ReflectionOperations;
        ...
        {
            var testLevelDeploymentItems = this.GetDeploymentItems(this.reflectionUtility.GetCustomAttributes(method, typeof(DeploymentItemAttribute), false), warnings);
        ...
        {
            return testCase.GetPropertyValue(MSTest.TestAdapter.Constants.DeploymentItemsProperty) as
